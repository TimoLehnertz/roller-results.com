...
<script type="module">
    ...
    get("worldMovement").receive((succsess, data) => {
        ...
        for (const movement of data) {
            ...
            globe.trajectoryFromTo(movement.compLatitude + randomX, movement.compLongitude + randomY, movement.athleteLatitude, movement.athleteLongitude, {color: 0xff44aa}).animate("in", "forewards", 5000 * (Math.random() / 2 + 1));
        }
    });
