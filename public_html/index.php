            ...
            <div class="google-search-bar">
                <label for="search-input">
                    <div class="search">
                        ...
                        <input <?=$searching ? "" : "autofocus"?> type="text" name="q" value="<?=htmlentities($searchString)?>" spellcheck="false" autocomplete="off" id="search-input" placeholder="Search" title="Suche">
