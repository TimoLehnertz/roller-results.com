...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/styles/main.css?v=1.19">
        <!-- GOOGLE fonts -->
        ...
        <script src="/js/ajaxAPI.js?v=2.2"></script>
        <script src="/js/lib.js?v=2.2"></script>
        <script src="/js/ui.js?v=2.6"></script>
        <script src="/js/interface.js?v=2.3"></script>
        <script src="/js/html2canvas/html2canvas.js" defer></script>
        <script>
            <?php echo "const phpUId = '".uniqid($_SERVER["SERVER_NAME"], true)."';";?>
        </script>
        <script src="/js/log.js?v=1.2"></script>
        <script>
            <?php if(isLoggedIn()) { 
                $user = getUser($_SESSION["iduser"]);
                ?>
