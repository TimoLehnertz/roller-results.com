...
--
-- Dumping data for table `tbimportproject`
--

LOCK TABLES `tbimportproject` WRITE;
/*!40000 ALTER TABLE `tbimportproject` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbimportproject` ENABLE KEYS */;
UNLOCK TABLES;
